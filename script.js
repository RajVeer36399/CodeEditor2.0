...
<section class="card" style="max-width:520px;margin:24px auto;padding:18px;text-align:center; font-size: 14px;">
  <h1>Welcome to the Code Editor 2.0</h1>
...
function saveProject(){
  try{
    ...
    a.download = 'codeEditor-web.json';
    a.click();
...
// log('Web-only Editor (HTML/CSS/JS)');
